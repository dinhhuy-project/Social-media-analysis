...
Được tạo ra thông qua các kỹ thuật dữ liệu tổng hợp tiên tiến sử dụng các công cụ như NumPy và Pandas, bộ dữ liệu này mô phỏng các tình huống sử dụng mạng xã hội trong thế giới thực. Mặc dù được tạo ra một cách nhân tạo, nó vẫn phản ánh chính xác các xu hướng sử dụng thực tế, khiến nó trở thành một tài sản giá trị cho việc nghiên cứu và phân tích hành vi trên mạng xã hội.

4. Social Media vs Productivity (Phương tiện truyền thông xã hội so với năng suất)

📊 Mạng xã hội so với năng suất — Bộ dữ liệu hành vi thực tế (30.000 người dùng)
Bộ dữ liệu này khám phá mối liên hệ giữa các thói quen kỹ thuật số hàng ngày — bao gồm việc sử dụng mạng xã hội, thời gian sử dụng màn hình và mức độ tiếp xúc với thông báo — với năng suất, căng thẳng và sức khỏe của cá nhân .
🔍 Bên trong có gì?
Bộ dữ liệu này chứa 30.000 hồ sơ theo phong cách thực tế, mô phỏng các mô hình hành vi của những người có nghề nghiệp, thói quen xã hội và lối sống khác nhau. Mục tiêu là tìm hiểu mối tương quan giữa các hành vi kỹ thuật số khác nhau với năng suất thực tế và năng suất được nhận thức .

5. Social Media and Mental Health Balance (Sự cân bằng giữa mạng xã hội và sức khỏe tâm thần)
